...
// console.log(greatrerThanMass)

// Get all male characters
const maleCh = characcters.filter((character) => character.gender == 'male')
console.log(maleCh);

// Sort by gender
const sortByGender = characters.sort((character1, character2) => {
    if (character1.name > character.name) {
        return -1;
    }
...
// console.log(characters.every((character) => character.eye_color == 40))
